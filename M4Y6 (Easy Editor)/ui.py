...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.horizontalLayoutWidget.setGeometry(QtCore.QRect(160, 490, 631, 71))
        ...
        self.btn_2.setStyleSheet("background-color: rgb(255, 170, 255);")
        self.btn_2.setObjectName("btn_2")
        self.horizontalLayout.addWidget(self.btn_2)
        self.btn_1 = QtWidgets.QPushButton(self.horizontalLayoutWidget)
        self.btn_1.setStyleSheet("background-color: rgb(255, 170, 255);")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.btn_2.setText(_translate("MainWindow", "Яскравість"))
        self.btn_1.setText(_translate("MainWindow", "Олівець"))
